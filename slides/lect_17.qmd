...
4.  $\begin{aligned} \chi^2 &= sum\frac{(observed - expected)^2}{expected} \\ &= \frac{(100-81.7)^2}{81.7} + \frac{(70-88.3)^2}{88.3} + ... + \frac{(120-199.5)^2}{119.5}\\ &\approx 5.0999\end{aligned}$ $df = (3-1)\cdot(2-1)$
:::
