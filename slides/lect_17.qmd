...
There are few places where $\chi^2$ tests are particularly useful. For example, in fraud detection. [Benford's law](https://en.wikipedia.org/wiki/Benford%27s_law)  outlines the proportion of first digits that are 1 - 9 in a number.  
