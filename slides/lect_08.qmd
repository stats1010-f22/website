...
The size of the lettering of the numbers is related to the number.
:::
...
::: incremental
1.  Usually referred to as $r$
2.  Strength of linear association
3.  $r$ is always between $-1$ and $+1$ $-1 \leq r \leg 1$.
...
##  {background-image="lect-08_things/correlation_coef.png"}
...
$r = 0.9215913$ $s_{price} = 3989.44$ $s_{carat} = 0.4740112$
...
## Find the prediction
predict(least_squares_fit, 
        tibble(carat = c(1, 2, 2.5, 4)))
```
...
Might lurking variables explain these relationships?
