...
1.  Set the control limits and find the $\alpha$ value
    -   We want the control limits to be between 10 and 14
    -   $\begin{aligned}P(\bar{X} > 14) &= P(\frac{\bar{X} - }{\sigma_\bar{X}} > \frac{14-\mu_\bar{X}}{\sigma_\bar{X}}) \\ & = P(Z > \frac{14-12}{\sqrt{2.3}} = 1.318761)\end{aligned}$
...
#{background-image="lect-13_things/control_plot.png" background-size="contain"}
