...
#  {background-image="lec_11-thingss/p_greater_1.png" background-size="contain"}


#  {background-image="lec_11-thingss/emperical_rule.png" background-size="contain"}


# Percentiles

::: notes
Earlier we used the normal to find a percent, you can also use `R` to find the value associated with that percent.
:::
