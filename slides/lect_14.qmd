...
$$ \hat{p} \sim N(\mu = p, \sigma^2 = \frac{p(1-p)}{n}) $$ ::: incremental - numerator of the variance is similar to that of a Binomial distribution - as sample size increases, variance decreases :::
...
An auditor checks a sample of 225 randomly chosen transactions from among the thousands processed in an office. Thirty-five contains errors in crediting or debiting the appropriate account a. Does this situation meet the conditions required for a $z$-interval for the proportion? b. Find the $95\%$ confidence interval for $p$, the proportion of all transactions processed in the this office that have these errors. c. Managers claim that the proportion of errors is about $10\%$. Does that seem reasonable?
...
-   upper value: $3285 + 1.976 \cdot 19.43262 \approx \$3,2$
...
-   `4200 + qt(.025, df = 48)*3500/sqrt(49)`
