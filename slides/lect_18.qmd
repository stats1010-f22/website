...
This [classic example](https://www.callingbullshit.org/case_studies/case_study_gender_gap_running.html) is one of my favorites.

The model is only useful *near* the values for which we have data. Outside of those values anything could happen.
