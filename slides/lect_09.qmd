...
::: {.column width="50%"}
::: incremental
\_ What is the probability that $x = 0$ and $y =4$? - $11\%$

\_ What is the probability that $x = 5$ and $y =4$? - $7\%$

\_ What is the probability that $x = 0$ and $y =0$? - $62\%$

\_ What outcome will never occur? - $x = -5$ and $y =4$
:::
:::
:::
...
::: incremental
\_ If $X$ and $Y$ and independent then $p(x,y) = p(x) \cdot p(y)$

\_ If $p(x,y) = p(x) \cdot p(y)$ then $X$ and $Y$ are independent.

\_ It follows that if $X$ and $Y$ are independent, then $E(XY) = E(X) \cdot E(Y)$
:::
...
::: incremental
\_ $p_x(-5) \cdot p_y(4) = 0.18 \cdot 0.09 \neq 0.00$

\_ $p_x(-5) \cdot p_y(-4) = 0.09 \cdot 0.15 = 0.0135 \neq 0.06$
