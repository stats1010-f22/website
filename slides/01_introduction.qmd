...
footer:  "[stat1010-f22.github.io/website](https://sta1010-f22.github.io/website/)"
format: 
  revealjs: 
    theme: slides.scss
    transition: fade
...
Use the QR code below or [click here](https://github.com/stats1010-f22/website/blob/main/slides/lec_1_images/first_line_of_code.html)

```{r, eval=TRUE, echo=FALSE}
library(qrcode)
qr <- qr_code("https://github.com/stats1010-f22/website/blob/main/slides/lec_1_images/first_line_of_code.html")
plot(qr)
```
...
Use the QR code below or [click here.](https://sctyner.me/post/2019-2-17-rhelp)
