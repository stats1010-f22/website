...
13. What combination of Gender and Alignment has the highest proportion? What is it? What is the sum of all of the proportions in the table below? (Note: go through each line of code and ensure you know what each step does)
...
14. 
    ...
    ```{r conditional_proportion, eval=FALSE, echo=TRUE}
    #| message: false
    #| warning: false
    #| eval: false
    #| echo: true
