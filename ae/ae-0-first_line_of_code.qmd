...
So far we have been looking at only 1 continuous variable. To look at two continous variables, we will draw a scatterplot.
...
## Color and fill variables
ggplot(data = diamonds) +
      geom_scatter(mapping = aes(x = price, y = depth)) 
```
