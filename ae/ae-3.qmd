...
11. Run each line of the code above and ensure that you understand how this computation was developed. This shows us how to find $s_{price}^2$ directly.

12. Find $s_{x}^2$, $s_{y}^2$, and $s_{z}^2$ using both directly, and having `R` do the computation. (hint: you will need to insert 6 code chunks)
