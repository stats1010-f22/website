...
2.  Looking at the above plots, count the percentage of yellow dots in each of the dotplots?
3.  Compare and contrast a dotplot and a boxplot? What are the advantages and disadvantages of each? Think carefully about bimodal data and how which plot you would use to show that aspect of a variable.
