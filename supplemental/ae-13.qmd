...
14. If the *p*-value of the test of H~0~ is less than *α*, then the test has produced a Type II error.
...
20. By setting a small *α*-level, the accounting firm reduces the chance of a test indicating that it should add this new service even though it is not profitable.
...
![](ae_13-images/chpt_19-scatterplot.png){width="177"}
...
28. This histogram summarizes residuals from a fit that regresses the number of items produced by 50 employees during a shift on the number of years with the company. Estimate $s_e$ from this plot. ![](ae_13-images/chpt_19-ques_28.png)
